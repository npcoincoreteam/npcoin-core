...
const string strMessageMagic = "NPCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NPCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        // MainNet:
        const char* pszTimestamp = "Three Russian Universities Add Crypto Courses and Diplomas";
        CTransaction txNew;
        txNew.nTime = 1531709947;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1531709947;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 3433010 : 101452;

        assert(block.hashMerkleRoot == uint256("0xb393cc4472ed90ca92839c65cd597eddc1dfcd3d61e4ef35064c88fc0c1c77e9"));
...
unsigned char pchMessageStart[4] = { 0xc0, 0x1d, 0x22, 0x9d };
